...
def main() -> None:
    ...
    parser.add_argument('-n', '--repo_count', type=int, default=1,
                        help='Number of repositories to analyze')
    parser.add_argument('-s', '--skip_repos', type=int, default=0,
                        help='Number of repositories to skip')
    ...
    Analyzer.analyze(repo_count, skip_repos, analyze_repos, statistic_tests, experiment_names)
